...
function HomeSwiperCervezas() {
    ...
    return (
        <section id='HomeSwiperCervezas'>
            <Swiper id='Swiper-Container' modules={[Pagination, Autoplay]} autoplay={{delay: 4000}} spaceBetween={50} onSlideChange={() => {console.log('cambio el slide')}} slidesPerView={1} pagination={{clickable: true}} onSwiper={(swiper) => console.log(swiper)}>
